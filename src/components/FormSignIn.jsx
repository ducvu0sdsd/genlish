...
const FormSignIn = ({ visible, hidden }) => {
    ...
    return (
        <section style={{ top: visible ? '0' : '100%', transition: '0.4s' }} className='z-[45] flex items-center justify-center fixed left-0 w-screen h-screen transition-all bg-[white]'>
            ...
            }} className="bg-[#149dff] absolute top-3 right-4 hover:scale-[1.06] transition-all text-[white] shadow-xl border-[1px] border-[#e4e4e4] font-bold text-[16px] w-[10%] py-[7px] rounded-lg">Đăng Ký</button>
