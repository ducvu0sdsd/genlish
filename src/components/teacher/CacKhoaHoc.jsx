                        ...
                        <>
                            {courses.length > 0 && (
                                <div className='w-full flex flex-col mt-[1rem] pb-[1rem] gap-2 h-[100%]'>
                                    ...
                                    <div className='w-full grid grid-cols-4 gap-3 py-[0.5rem] max-h-[100%] overflow-y-auto'>
                                        {courses.map((course, index) => (
                                            <div onClick={() => setCurrentCourse(course)} className='transition-all hover:scale-[1.05] cursor-pointer flex flex-col w-[full] pb-2 shadow-xl rounded-xl' key={index}>
